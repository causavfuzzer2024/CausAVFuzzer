...
class ScenarioElements:
    def __init__(self, scenario, isGroundTruth):
        ...
        self.weather = {}
        self.extraction()
        # print('\nIn ScenarioElements')  # DEBUG
        # print(self.ObsNumber)
        # print(self.obstacles)
        # print(self.PedestrianNumber)
    ...
    def get_obss(self):
        if self.scenario.has_obstacles():
            obss_obj = self.scenario.get_obstacles()
            self.ObsNumber = obss_obj.get_size()
            obss_obj_list = obss_obj.get_obstacles()
            # print('\nIn get_obss@ScenarioElements')  # DEBUG
            # print(obss_obj)
            # print(obss_obj_list)
            for _i in range(len(obss_obj_list)):
                obs_obj = obss_obj_list[_i]
...
class TestCase:
    ...
    def GetFromLGSVL(self, lgsvl_filter_testcase):
        ...
        # print('\nIn GetFromLGSVL@TestCase')  # DEBUG
        # print(self.ObsNumber)
...
class AllTestCase:
    ...
    def test_cases_json(self, isGroundTruth) -> List[str]:
        ...
        for _i in range(len(self.scenarios)):
            raw_scenario_i = ScenarioElements(self.scenarios[_i], isGroundTruth)  # DEBUG
