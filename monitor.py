...
class Monitor:
    ...
    def prepare_traffic_rule_related_APIs(self, _time ,state_len , _var_data, name_of_vaiable):
        # @tikrgi: For Issue#1
        self.c_data[name_of_vaiable] = [[_time[i], _var_data[i] if i < len(_var_data) else 0] for i in range(state_len)]
...
if __name__ == "__main__":
    ...
    # input_file = 'test_cases/customized_scripts/Intersection_with_Double-Direction_Roads.txt'
    input_file = 'test_cases/CAV_scripts/script-0.txt'
    # input_file = 'test_cases/traffic_rule_tests/Intersection_with_Double-Direction_Roads.txt'
