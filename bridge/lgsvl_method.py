    ...
    def check_is_lane_changing(self):
        ...
        if len(self.trace) >= -num_of_track:
            if self.trace[num_of_track]["ego"]["isLaneChanging"] == False:
                ...
                if "currentLane" in previous_trace["ego"] and "currentLaneId" in previous_trace["ego"]["currentLane"]:
                    # @tikrgi: for Issue#1
                    ...
                    if previous_trace["ego"]["planning_of_turn"] != 0:
                        ...
                        for num in range(num_of_track+1,0):
                            dest = None
                            if "currentLane" in self.trace[num]["ego"] and "currentLaneId" in self.trace[num]["ego"]["currentLane"]:
