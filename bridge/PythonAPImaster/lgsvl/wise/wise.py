...
class DefaultAssets:
    ...
    map_sanfrancisco = "12da60a7-2fc9-474d-a62a-5cc08cb97fe8"
    ...
    ego_lincoln2017mkz_apollo6_modular = "2e966a70-4a19-44b5-a5e7-64e00a7bc5de"  # Perception ground truth
    # MARK: 3D ground truth sensor cannot detect pedestrians in svl simulator 2021.3